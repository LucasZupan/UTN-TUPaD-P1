...
mis_favoritos = ["Bench press", "Deadlift", "Dips", "Squat", "Pull ups"]
...
#El programa remueve de la lista numeros el maximo y vuelve a imprimir la lista sin ese elemento, en este caso el 22.
